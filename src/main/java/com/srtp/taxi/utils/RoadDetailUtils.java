...
public class RoadDetailUtils {
    ...
    public static int getDistance(double startLng,double startLat,double endLng,double endLat){
        JsonRootBean js;
        while (true){
            js=getRoadDetail("https://apis.map.qq.com/ws/distance/v1/matrix/?mode=driving&from="+startLat+","+startLng+"&to="+endLat+","+endLng+"&key=MMBBZ-BIALF-NTNJV-JJ74D-APHP2-UHFSM"
